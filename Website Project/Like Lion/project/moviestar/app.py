...
def stars_list():
    ...
    # We need to create the second part of the code where we use json to message the client
    return jsonify({'result': 'success','msg':'list 연결되었습니다!', 'stars_list':stars})


@app.route('/api/like', methods=['POST'])
# adds like to the celebrity when button is clicked
def star_like():
...
# deletes the celebrity card when called
def star_delete():
    # 1. 클라이언트가 전달한 name_give를 name_receive 변수에 넣습니다.
